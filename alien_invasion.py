...
class AlienInvasion:
    ...
    def _fire_bullet(self):
        """Create a nwe bullet and add it to the bullets group."""
    ...
    def _create_fleet(self):
        ...
        # Space between each alien is equal to one alien with.
        alien = Alien(self)
        ...
        available_space_y = ( self.settings.screen_height
                              - ( 3 * self.settings.alien_height ) - self.settings.ship_height )
        number_rows = available_space_y // (2 * self.settings.alien_height )
